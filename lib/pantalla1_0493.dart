...
class Pantalla1_0493 extends StatefulWidget {
  const Pantalla1_0493({Key? key}) : super(key: key);

  @override
  Pantalla1_0493State createState() => Pantalla1_0493State();
}

class Pantalla1_0493State extends State<Pantalla1_0493> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: const Text("Pagina 1 Jimenez 0493"),
          backgroundColor: Color(0xff1b6393),
        ),
        body: Center(
          child: Card(
